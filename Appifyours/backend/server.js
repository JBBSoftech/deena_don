...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/deena_don_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '694ad5d182bed05192ff3c60',
      shopName: 'Deena don',
...
app.listen(PORT, () => {
  console.log(`Deena don Backend Server running on port ${PORT}`);
});
